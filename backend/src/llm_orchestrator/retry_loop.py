...
2. On :class:`~src.llm_orchestrator.agents.AgentParseError`, the loop invokes
   :class:`~src.llm_orchestrator.agents.FixerAgent` with the malformed
...
:mod:`src.llm_orchestrator.agents` keeps the agents single-purpose (one
...
from src.llm_orchestrator.cost_tracker import CostRecord, CostTracker
