...
_TOOLS: list[ToolRegistryEntry] = [
    ...
    ToolRegistryEntry(
        ...
        "dns_asn",
        "shuffledns -version",
        "shuffledns -d {target} -w wordlist.txt",
        "text",
        "text_lines",
        "safe",
        False,
    ...
    ToolRegistryEntry(
        ...
        "url_history",
        "httprobe -h",
        "httprobe -c 50 < {target}_subs.txt",
        "text",
        "text_lines",
        "safe",
        False,
    ...
    ToolRegistryEntry(
        ...
        "url_history",
        "aquatone -version",
        "aquatone -out screenshots -ports 80,443",
        "png",
        "binary_files",
        "safe",
        False,
    ...
    ToolRegistryEntry(
        ...
        True,
        "Masscan",
        notes="requires_explicit_permission due to high scan rate",
    ),
    ToolRegistryEntry(
        "rustscan",
        "port_discovery",
        "rustscan --version",
        "rustscan -a {target} --range 1-65535 --timeout 2000",
        "text",
        "text_lines",
        "safe",
        False,
    ...
    ToolRegistryEntry(
        ...
        True,
        "ZMap",
        notes="requires_explicit_permission — network-wide scan",
    ),
    ToolRegistryEntry(
        "amap",
        "port_discovery",
    ...
    ToolRegistryEntry(
        ...
        "tls_assessment",
        "tlsx -version",
        "tlsx -host {target} -port 443 -silent",
        "json",
        "json_parser",
        "safe",
        False,
    ...
    ToolRegistryEntry(
        "corscanner",
        "security_headers",
        "python3 corscanner.py --help",
        "python3 corscanner.py -u {target}",
        "text",
        "text_stdout",
        "safe",
        False,
    ...
    ToolRegistryEntry(
        ...
        "web_server_scan",
        "nikto -Version",
        "nikto -h {target} -Tuning 1,2,3,4,5,6,7,8,9",
        "text",
        "nikto_parser",
        "moderate",
        False,
    ...
    ToolRegistryEntry(
        ...
        "web_server_scan",
        "jaeles version",
        "jaeles scan -s signatures/ -u {target}",
        "text",
        "json_parser",
        "moderate",
        False,
    ...
    ToolRegistryEntry(
        ...
        "interactsh-client -o output.txt",
        "text",
        "text_stdout",
        "safe",
        False,
    ...
    ToolRegistryEntry(
        ...
        False,
        "Nuclei",
        notes="high risk — generates live traffic",
    ),
    ToolRegistryEntry(
        "dalfox",
        "vuln_active_scan",
        ...
        False,
        "Dalfox",
        notes="XSS scanning — requires permission",
    ),
    ToolRegistryEntry(
        "ffuf",
        "vuln_active_scan",
    ...
    ToolRegistryEntry(
        ...
        "vuln_active_scan",
        "feroxbuster --version",
        "feroxbuster -u {target} -w wordlist.txt --silent",
        "text",
        "feroxbuster_parser",
        "moderate",
        False,
    ...
    ToolRegistryEntry(
        ...
        "vuln_active_scan",
        "wfuzz --version",
        "wfuzz -c -z file,wordlist.txt --hc 404 {target}/FUZZ",
        "text",
        "wfuzz_parser",
        "moderate",
        False,
    ...
    ToolRegistryEntry(
        ...
        True,
        "SQLMap",
        notes="critical risk — database write possible; requires explicit authorization",
    ),
    ToolRegistryEntry(
        "commix",
        "vuln_active_scan",
        "commix --version",
        'commix --url {target} --data "param=1" --batch',
        "text",
        "commix_parser",
        "critical",
        False,
        True,
        "Commix",
        notes="critical risk — OS command execution possible; requires explicit authorization",
    ),
    ToolRegistryEntry(
        "tplmap",
        "vuln_active_scan",
        ...
        True,
        "Tplmap",
        notes="critical risk — server-side template injection; requires explicit authorization",
    ),
    ToolRegistryEntry(
        "arjun",
        "vuln_active_scan",
    ...
    ToolRegistryEntry(
        "qsreplace",
        "vuln_active_scan",
        "echo test | qsreplace --help",
        "qsreplace payload.txt < urls.txt",
        "text",
        "text_lines",
        "safe",
        False,
    ...
    ToolRegistryEntry(
        ...
        "sca_dependencies",
        "trivy --version",
        "trivy fs --scanners vuln,secret,config {path}",
        "json",
        "trivy_parser",
        "safe",
        False,
    ...
    ToolRegistryEntry(
        ...
        "cms_scan",
        "wpscan --version",
        "wpscan --url {target} --enumerate p,u,t,tt --api-token $WPSCAN_API_TOKEN",
        "text",
        "wpscan_parser",
        "moderate",
        False,
        False,
        "WPScan",
        notes="recommended: set WPSCAN_API_TOKEN",
    ),
    ToolRegistryEntry(
        "droopescan",
        "cms_scan",
    ...
    ToolRegistryEntry(
        ...
        "api_security",
        "kiterunner version",
        "kiterunner scan -w routes.kite {target}",
        "text",
        "text_lines",
        "moderate",
        False,
    ...
    ToolRegistryEntry(
        ...
        True,
        "Hydra",
        notes="critical risk — account lockout possible; requires explicit permission",
    ),
    ToolRegistryEntry(
        "patator",
        "auth_testing",
        "patator --version",
        "patator http_fuzz url={target}/login method=POST body='user=FILE0&pass=FILE1' 0=users.txt 1=passwords.txt",
        "text",
        "patator_parser",
        "critical",
        True,
    ...
    ToolRegistryEntry(
        ...
        "cloud_security",
        "cloud_enum --version",
        "cloud_enum -k {keyword} -m {mutations}",
        "text",
        "text_lines",
        "safe",
        False,
    ...
    ToolRegistryEntry(
        ...
        True,
        "ScoutSuite",
        notes="requires valid cloud credentials",
    ),
    ToolRegistryEntry(
        "prowler",
        "cloud_security",
    ...
    ToolRegistryEntry(
        ...
        True,
        "Kube-Hunter",
        notes="active scanning of K8s cluster; requires explicit permission",
    ),
    ToolRegistryEntry(
        "kube-bench",
        "container_security",
    ...
    ToolRegistryEntry(
        ...
        False,
        "SecurityTrails",
        notes="requires SECURITYTRAILS_API_KEY",
    ),
    ToolRegistryEntry(
        "virustotal",
        "email_osint",
        ...
        False,
        "VirusTotal",
        notes="requires VIRUSTOTAL_API_KEY",
    ),
    ToolRegistryEntry(
        "abuseipdb",
        "email_osint",
        ...
        False,
        "AbuseIPDB",
        notes="requires ABUSEIPDB_API_KEY",
    ),
    ToolRegistryEntry(
        "urlscan",
        "email_osint",
        ...
        False,
        "urlscan.io",
        notes="requires URLSCAN_API_KEY",
    ),
    # ── Browser / DAST ──
    ToolRegistryEntry(
        "playwright",
    ...
    ToolRegistryEntry(
        ...
        True,
        "ZAP Full Scan",
        notes="high risk — active scanning suite",
    ),
    ToolRegistryEntry(
        "zap-api-scan",
        "vuln_active_scan",
    ...
    ToolRegistryEntry(
        ...
        True,
        "Burp Suite Scanner",
        notes="commercial tool — requires license",
    ),
    ToolRegistryEntry(
        "mitmproxy",
        "content_discovery",
    ...
    ToolRegistryEntry(
        ...
        True,
        "Azucar",
        notes="Azure security audit — requires Azure credentials",
    ),
    ToolRegistryEntry(
        "waf-tester",
        "security_headers",
        ...
        False,
        "WAF Tester",
        notes="WAF detection and bypass testing",
    ),
]
