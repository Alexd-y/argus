"""Stage 1 enrichment builder for unrestricted pentest operations.

This module expands Stage 1 reporting with:
- Route/page discovery
- JavaScript analysis (full exploitation payloads)
...
def _build_fetcher(
    ...
    falls back to MCP fetch for full HTML/JS retrieval and exploitation.
    ...
    *,
    ...
    lines.extend(
        [
            ...
            "---",
            "",
            "*Generated by ARGUS Stage 1 enrichment (unrestricted pentest).*",
        ]
    )
    return "\n".join(lines)
