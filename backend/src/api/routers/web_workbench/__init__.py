...
from src.api.routers.web_workbench.intruder import router as intruder_router
...
from src.api.routers.web_workbench.sessions import router as sessions_router
...
web_workbench_router.include_router(intruder_router)
web_workbench_router.include_router(sessions_router)
