...
REQUIRED_OPENAPI_PATHS = [
    ...
    "/api/v1/reports",
    "/api/v1/wb/projects",
    "/api/v1/wb/projects/{project_id}",
    "/api/v1/wb/projects/{project_id}/eap",
    "/api/v1/wb/projects/{project_id}/proxy/listeners",
    "/api/v1/wb/projects/{project_id}/proxy/history",
    "/api/v1/wb/proxy/listeners/{listener_id}",
    "/api/v1/wb/proxy/listeners/{listener_id}/ca",
    "/api/v1/wb/proxy/messages/{message_id}",
    "/api/v1/wb/tools/decoder",
    "/api/v1/wb/tools/comparer",
    "/api/v1/wb/tools/message-format",
    "/api/v1/wb/projects/{project_id}/organizer/collections",
    "/api/v1/wb/organizer/collections/{collection_id}",
    "/api/v1/wb/organizer/collections/{collection_id}/items",
    "/api/v1/wb/projects/{project_id}/organizer/items",
    "/api/v1/wb/organizer/items/{item_id}",
    "/api/v1/wb/projects/{project_id}/repeater/tabs",
    "/api/v1/wb/repeater/tabs/{tab_id}",
