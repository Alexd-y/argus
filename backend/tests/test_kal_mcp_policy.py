...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "ssl_analysis",
            ["openssl", "s_client", "-connect", "x:443"],
            False,
            False,
            True,
        ),
        ...
        (
            "asn_mapping",
            ["asnmap", "-d", "example.com", "-silent", "-json"],
            False,
            False,
            True,
        ),
        ...
        (
            "web_screenshots",
            ["gowitness", "-q", "scan", "single", "-u", "https://x", "-s", "/tmp/gw"],
            False,
            False,
            True,
        ),
